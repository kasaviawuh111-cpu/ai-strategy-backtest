...
依据 docs/release-public-004-20260906.md

依据 docs/bug-backlog-and-acceptance.md
...
依据 ashare_lab/api/skill_app.py

依据 ashare_lab/adapters/market_data/mx_indicator_contract.py

依据 ashare_lab/application/skill_backtest_service.py
...
依据 ashare_lab/application/skill_backtest.py
...
依据 ashare_lab/adapters/market_data/mx_daily_history.py

依据 ashare_lab/application/skill_backtest_service.py

依据 docs/bugfix-execution-settings-20260906.md
...
依据 ashare_lab/domain/analytics/metrics.py

依据 docs/releases/public-004-acceptance.json
...
依据 ashare_lab/adapters/language/vibe_candidates.py

依据 ashare_lab/adapters/language/vibe_backtest_review.py

依据 ashare_lab/adapters/language/vibe_ideas.py
...
依据 ashare_lab/api/routes/strategy_drafts.py

依据 deploy/private_preview/dialogue_requests.py

依据 ashare_lab/application/skill_backtest_service.py

依据 docs/bugfix-concurrency-20260906.md

依据 docs/release-public-005-20260906.md
...
依据 docs/releases/public-004-source-manifest.json

依据 docs/releases/public-004-acceptance.json

依据 docs/releases/public-005-acceptance.json
